...
local function LoadSkin()
	...
	local function SmallSkin()
		...
		--WorldMapDetailFrame.backdrop:Point("TOPLEFT", -E.Border*2, E.Border*2)
		--WorldMapDetailFrame.backdrop:SetPoint("BOTTOMRIGHT", E.Border*1, -E.Border*2)
	end
	...
	local function LargeSkin()
		...
		--WorldMapDetailFrame.backdrop:SetOutside()
	end
	...
	local function FixSkin()
		...
		--print(WorldMapDetailFrame:GetScale(), WorldMapDetailFrame.backdrop:GetScale())
		--WorldMapDetailFrame.backdrop:SetScale(1)
	end
